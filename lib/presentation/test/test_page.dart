...
class _MainTestPageState extends State<MainTestPage> {
  List<Questions> questions = [
    Questions([
      Answer('Общаться с самыми разными людьми'),
      Answer('Снимать фильмы, писать книги, рисовать, выступать на сцене и т.д'),
      Answer('Заниматься расчетами, вести документацию'),
    ], 'Мне хотелось бы в своей профессиональной деятельности:'),
    Questions([
      Answer('Художественная форма, мастерство писателя или режиссера'),
      Answer('Сюжет, действия героев'),
      Answer('Возможность следить за ходом мыслей автора'),
