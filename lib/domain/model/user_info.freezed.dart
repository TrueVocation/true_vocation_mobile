...
abstract class $UserInfoCopyWith<$Res> {
  ...
  $Res call({int? id, String? phoneNumber, String? birthdate, User? user});
}
...
class _$_UserInfo with DiagnosticableTreeMixin implements _UserInfo {
  const _$_UserInfo({this.id, this.phoneNumber, this.birthdate, this.user});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserInfo(id: $id, phoneNumber: $phoneNumber, birthdate: $birthdate, user: $user)';
  }
